...
import { $, $$ } from './ui/kit.js?v=20260903170948'
import * as home from './ui/home.js?v=20260903170948'
import * as review from './ui/review.js?v=20260903170948'
import * as result from './ui/result.js?v=20260903170948'
import * as doc from './ui/doc.js?v=20260903170948'
...
;(async () => {
  const { available, tipHtml, mountTip } = await import('./tip.js?v=20260903170948')
  const link = $('#tip-link')
