...
import { $, $$, esc, toast, confirmBox, alertBox } from './kit.js?v=20260903172922'
import * as job from '../job.js?v=20260903172922'
import * as store from '../store.js?v=20260903172922'
import * as pdfdoc from '../pdfdoc.js?v=20260903172922'
import * as textpick from '../textpick.js?v=20260903172922'
import { detectLines } from '../detect.js?v=20260903172922'
import { loadBitmap } from '../redact.js?v=20260903172922'
import { go } from '../main.js?v=20260903172922'
...
function shell() {
  ...
  <section class="review">
    ...
    <div class="rv-note">
      <p>打码界面显示半透明框选为方便核对，<b>导出打码件为不透明实色体。</b></p>
      <p><b>照片、公章、签名无法自动识别。</b>请自行框选。</p>
    </div>
